class MedianFinder {
    ...
    public double findMedian() {
        // if len(smallHeap) < len(largeHeap) then return peek of largeHeap
        // if len(smallHeap) > len(largeHeap) then return peek of smallHeap
        // else return (smallHeap[0] + largeHeap[0]) / 2
